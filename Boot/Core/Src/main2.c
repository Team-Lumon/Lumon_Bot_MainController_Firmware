...
void ExecuteApplication(void) {
  ...
  s_command.Instruction = 0x0B; // Fast Read command (0Bh)
  ...
  s_command.DummyCycles = 8; // 8 dummy cycles for 0Bh Fast Read
  ...
  // Only enter the diagnostic blinking loop if stackPointer or jumpAddress is invalid
